...
else if(strlen($l_pass)>15 || strlen($l_pass)<6)
{
...
'".$l_UR_MiddleName."','".$l_UR_LastName."','".$l_company_id."','".$l_UR_ProfileInfo."','".$l_Insert_Datetime ."','E','".$l_random_str."','".$l_Semester."',".$l_IT_id.",".$l_PG_id.",'".$l_UR_Org_id."')";
