        ...
        <div class="col-md-6 " >  
         ...
         <?php } ?>
                    ...
                    <div class="control-group" >
                        ...
                        <div class="controls">
                        <input type="number" id="amount" name="Amount" placeholder="Enter Amount" class="form-control input-lg">
                        <p class="help-block"></p>
                        </div>
                    </div>
...
?>
    ...
    <?php } ?>
                    ...
                    <div class="controls" style="margin-top:10px;">
                        ...
                        <?php  if($l_URPR_Type=='S'||$l_URPR_Type=='G' ||$l_URPR_Type=='A' ||$l_URPR_Type=='C' || $l_URPR_Type=='M'){ ?>
                        <input type="submit" onclick="return Validation()" style="float:right" name="user_submit" value="Go to pay" id="create_an_acc" class="btn btn-success ">
                        <?php } ?>
