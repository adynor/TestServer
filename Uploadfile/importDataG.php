...
if(isset($_POST['importSubmit'])){
   ...
   $db->query("UPDATE Users SET UR_Phno = '".$line[2]."',UR_DOB = '".$line[3]."' WHERE CONCAT(UR_Emailid,'@',UR_EmailidDomain) = '".$line[1]."'");
                }else{
...
$l_UR_LastName =$array_Name[$l_count-1];
 ...
 $sql="INSERT INTO Users(UR_id,UR_Emailid,UR_EmailidDomain,UR_Phno,UR_DOB,UR_RegistrationStatus,UR_Khufiya,UR_FirstName,UR_MiddleName,UR_LastName,UR_InsertDate,UR_Type,IT_id,PG_id) VALUES ('".$line[1]."','".$l_UR_Emailid."','".$l_UR_EmailidDomain."','".$line[2]."','".$line[3]."','B','".md5($line[3])."','".$l_UR_FirstName."','".$l_UR_MiddleName."','".$l_UR_LastName."','".$l_Insert_Datetime."','G',52,1)"; 
//line[0]=Name line[1]=email line[2]=phone line[3]=DOB
                    $db->query($sql);
                }
            }
...
//header("Location:homeG.php".$qstring);
echo "<script>window.location.href = 'homeG.php';</script>";
?>