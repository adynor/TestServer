...
<form action="" method="GET">
  ...
  <input style="height: 48px;" class="form-control" placeholder="<?php  echo $text;?>" value="<?php  echo $text;?>" type="text" name="stext">
  <span class="input-group-addon" ><input class="btn btn-primary" type="submit"    accesskey=Alt-S value="Search Content" ></span>
</form>       
 </div>
 <br>
 <?php
...
$l_count_project = count($data['docs']);
 ?>
       <div class="table-responsive col-md-12 "><h4><span  class="label label-success"> Engine : <?php  echo  $l_count_project;  ?></span></h4>
...
<tr>
    ...
    <tr> 
    <td style="width:40%">
        <b><?php echo $docs['title']; ?></b><span style= "    float: right;" class="label label-success">Rank
        <?php echo $i;
          ?></span>
        
    </td>
     <td style="width:60%" ><?php echo $docs['body']; ?><a href="read.html#<?php echo $docs['id']; ?>">Read more...</a></td>
</tr>
<?php $i++; } ?>
                           </table
                           <?php } ?>
